...
async function automateNaukriProfile() {
    ...
    try {
        ...
        await page.goto(('https://www.naukri.com/mnjuser/profile'), { timeout: 5000 });
        ...
        // Clear the text
        await page.fill(textareaSelector, 'Experienced Technology ProfesDetail-driven Technology Analyst with 5+ years of focus on End-to-End Testing, Manual QA, and Test Campaign coordination. Expertise in PDM/TDM tools, SQL, and KPI reporting to ensure robust and reliable software delivery.');
